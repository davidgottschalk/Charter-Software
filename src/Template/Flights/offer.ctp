...
<div class="customers view large-12 medium-9 columns">
    ...
    <div class="large-12 columns">
        <fieldset>
            ...
            <!-- <div class="large-9 columns" style="margin-left: -0.9375rem"> -->
            <div class="position:relative">
                ...
                <?}?>
                <div style="position:absolute; left:75%; top:60px;">
                    <?=$this->Html->image( 'type_'.$data['planeType']['id'].'.jpg', ['style'=>'height:150px;'] )?>
                </div>
            </div>
            <br>
            <br>
